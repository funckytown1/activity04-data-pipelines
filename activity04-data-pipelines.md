...
**Response**: When set to true messages shows the output of running that
line of code
...
**Response**: provides extra information on the format of the dataset
...
**Response**: I would plot a chart showing unemployment rates for each
major and choose the lowest one
...
**Response**: It work and math and com-sci are tied with 4 others for 0
unemployment
...
**Response**: Military Technologies has no women
...
**Response**: 10 majors with a median salary less than 36,000
